  ...
  return (
    <section className="py-18 md:py-24 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      <div className="max-w-screen-xl mx-auto px-4 sm:px-10 lg:px-16">
        ...
        <div className="mt-12">
          <div className="grid gap-7 md:gap-7 lg:gap-9 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
            {reasons.map((item, index) => (
              <div
                ...
                className="relative rounded-3xl border border-white/10 bg-white/7 backdrop-blur-xl shadow-[0_28px_90px_rgba(15,23,42,0.9)] overflow-hidden group flex flex-col h-full mn"
              >
